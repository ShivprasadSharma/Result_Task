...
public class NotificationFiles extends BaseModel implements java.io.Serializable
{
	...
	@Column(name = "DOCUMENT1", unique = false, length = 1000000)
	private byte[]				document1;

	@Column(name = "DOCUMENT1_TYPE", length = 100)
	private String				document1Type;

	@Column(name = "DOCUMENT2", unique = false, length = 1000000)
	...
	public String getByteArrayString()
	{
		...
		{
			return new String(Base64.encode(this.document1));
		} else
		{
			return "";
		}
