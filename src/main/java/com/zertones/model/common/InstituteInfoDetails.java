...
public class InstituteInfoDetails extends BaseModel implements java.io.Serializable
{
	 ...
	 *
	 * @Fetch(FetchMode.JOIN) private InstituteInfoMaster instituteInfotMaster;
	 */
	...
	{
		return "InstituteInfoDetails [listDtlId=" + listDtlId + ", value=" + value + ", description=" + description
				+ ", string1=" + string1 + ", string2=" + string2 + ", string3=" + string3 + ", sequenceNo="
				+ sequenceNo + ", number1=" + number1 + ", number2=" + number2 + ", number3=" + number3
				+ ", documentType=" + documentType + ", document1Type=" + document1Type + ", document2Type="
				+ document2Type + ", createdDate=" + "" + ", createdBy=" + "" + ", updatedDate=" + "" + ", updatedBy="
				+ "" + ", recordStatus=" + ", instituteInfotMaster=" + "" + "]";
	}
