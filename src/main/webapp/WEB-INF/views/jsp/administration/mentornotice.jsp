       ...
       <div class="modal-content" id="noticeFormModal">
				...
				<div class="modal-body">
					<form:form id="groupNotice" modelAttribute="groupNotice" enctype="multipart/form-data" commandName="groupNotice" action="${saveGroupNotice}" method="post" class="pure-form pure-form-aligned" role="form">
					  <div class="col-sm-12" >
					 	  <div class="col-sm-6">
					 	    <form:input type="hidden" path="mentor" value="${mentorId}" required="required" class="form-control"/>
					...
					<div class="col-sm-11">
					  ...
					  <div class="col-sm-6">
						 ...
						 <input type="file" id="notifile1" name="notificationFile" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,text/plain, application/pdf, image/*"  value="Upload Media" class="btn btn-default"  onchange="check1()" />
						  <p style="color:red" id="demo"></p> 
		               </div>
					</div>
					<div class="form-group">
						<div class="fileupload ">
							<input type="submit"  id="submitbtn" style="background-color:#d3efc6" value="Send Notice" class="btn " onmouseover="check1()">
						</div> 
					</div>
				</form:form>
			</div>
